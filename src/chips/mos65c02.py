...
class M65C02:
    ...
    def flip(self, stdscr, y, x):
        ...
        lines = [
                                                        "  +-----------------+  ",
                    f"{(self.circuit.pins&(1<< 0))>> 0:1d} | 1:VPB    RESB:40| {(self.circuit.pins&(1<<39))>>39:1d}",
                    f"{(self.circuit.pins&(1<< 1))>> 1:1d} | 2:RDY   PHI2O:39| {(self.circuit.pins&(1<<38))>>38:1d}",
                    f"{(self.circuit.pins&(1<< 2))>> 2:1d} | 3:PHI1O   SOB:38| {(self.circuit.pins&(1<<37))>>37:1d}",
                    f"{(self.circuit.pins&(1<< 3))>> 3:1d} | 4:IRQB   PHI2:37| {(self.circuit.pins&(1<<36))>>36:1d}",
                    f"{(self.circuit.pins&(1<< 4))>> 4:1d} | 5:MLB      BE:36| {(self.circuit.pins&(1<<35))>>35:1d}",
                    f"{(self.circuit.pins&(1<< 5))>> 5:1d} | 6:NMIB     NC:35| {(self.circuit.pins&(1<<34))>>34:1d}",
                    f"{(self.circuit.pins&(1<< 6))>> 6:1d} | 7:SYNC    RWB:34| {(self.circuit.pins&(1<<33))>>33:1d}",
                    f"{(self.circuit.pins&(1<< 7))>> 7:1d} | 8:VCC      D0:33| {(self.circuit.pins&(1<<32))>>32:1d}",
                    f"{(self.circuit.pins&(1<< 8))>> 8:1d} | 9: A0      D1:32| {(self.circuit.pins&(1<<31))>>31:1d}",
                    f"{(self.circuit.pins&(1<< 9))>> 9:1d} |10: A1      D2:31| {(self.circuit.pins&(1<<30))>>30:1d}",
                    f"{(self.circuit.pins&(1<<10))>>10:1d} |11: A2      D3:30| {(self.circuit.pins&(1<<29))>>29:1d}",
                    f"{(self.circuit.pins&(1<<11))>>11:1d} |12: A3      D4:29| {(self.circuit.pins&(1<<28))>>28:1d}",
                    f"{(self.circuit.pins&(1<<12))>>12:1d} |13: A4      D5:28| {(self.circuit.pins&(1<<27))>>27:1d}",
                    f"{(self.circuit.pins&(1<<13))>>13:1d} |14: A5      D6:27| {(self.circuit.pins&(1<<26))>>26:1d}",
                    f"{(self.circuit.pins&(1<<14))>>14:1d} |15: A6      D7:26| {(self.circuit.pins&(1<<25))>>25:1d}",
                    f"{(self.circuit.pins&(1<<15))>>15:1d} |16: A7     A15:25| {(self.circuit.pins&(1<<24))>>24:1d}",
                    f"{(self.circuit.pins&(1<<16))>>16:1d} |17: A8     A14:24| {(self.circuit.pins&(1<<23))>>23:1d}",
                    f"{(self.circuit.pins&(1<<17))>>17:1d} |18: A9     A13:23| {(self.circuit.pins&(1<<22))>>22:1d}",
                    f"{(self.circuit.pins&(1<<18))>>18:1d} |19:A10     A12:22| {(self.circuit.pins&(1<<21))>>21:1d}",
                    f"{(self.circuit.pins&(1<<19))>>19:1d} |20:A11     GND:21| {(self.circuit.pins&(1<<20))>>20:1d}",
                                                        "  +-----------------+  "
                ]
        for row, line in enumerate(lines):
