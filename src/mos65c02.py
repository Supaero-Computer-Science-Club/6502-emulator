...
class M65C02:
    ...
    def tick(self, pins):
        if (not (self._PINS & M65C02_PHI2) and (pins & M65C02_PHI2)):  # ((pins & M65C02_PHI2) & ((M65C02_PHI2 & self._PINS) ^ ((1<< 40) - 1))):
            ...
            self._RD()
            # BRK-s
            if   (self._IR == (0x00<<3|0)):print("BRK-s");self._SA(self._PC); # put PC on addr bus.
            ...
            # JMP-a
            elif (self._IR == (0x4c<<3|0)): print("JMP-a");self._SA(self._PC); self._INCPC();
            ...
            # STA-a
            elif (self._IR == (0x8d<<3|0)): assert(False);
            elif (self._IR == (0x8d<<3|1)): assert(False);
            elif (self._IR == (0x8d<<3|2)): assert(False);
            elif (self._IR == (0x8d<<3|3)): assert(False);
            ...
            # LDA-#
            elif (self._IR == (0xa9<<3|0)): assert(False);
            elif (self._IR == (0xa9<<3|1)): assert(False);
